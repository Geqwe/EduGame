...
public class SeventhGameManager : MonoBehaviour
{
    public static SeventhGameManager instance;
    ...
    public void Right() {
        ...
        if(checkNextLevel==numberOfDesicions) {
            string game = PlayerPrefs.GetString("gameName", "\"Seventh\"");
    ...
    IEnumerator Fade() {
        ...
        SceneManager.LoadScene("SeventhLevelSelect");
    }
